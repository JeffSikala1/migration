...
$mycon = getconn();
$forids = array(303,295,292,304,298,293);
...
function printhead ($fromdate, $todate) {
    ...
    echo "<tr id=\"heading\"><th onclick=\"sortTable(0)\">Host Name   &#9653;&#9662;</th><th onclick=\"sortTable(1)\">Service Name   &#9653;&#9662;</th><th onclick=\"sortTable(1)\">SLA   &#9653;&#9662;</th></tr>\n";
}
